...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[9999] bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl hover:shadow-2xl transition-all duration-300 hover:scale-110 group min-w-[60px] min-h-[60px] flex items-center justify-center border-2 border-white"
